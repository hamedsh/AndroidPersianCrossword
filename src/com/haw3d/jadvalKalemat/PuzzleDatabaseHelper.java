...
import com.haw3d.jadvalKalemat.BrowseActivity.SortOrder;
...
public class PuzzleDatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void debugCopyDatabaseFileToExternalStorage()
    {
        try
        {
            ...
            try
            {
                File tempFile = new File(jadvalKalematApplication.TEMP_DIR, "crosswords.db");
    ...
    public long addPuzzle(File path, String source, String sourceUrl, long dateMillis)
    {
        ...
        try {
            ...
            path.renameTo(new File(jadvalKalematApplication.QUARANTINE_DIR, path.getName()));
            return -1;
        }
        ...
        values.put(COLUMN_SOURCE, puz.getSource());

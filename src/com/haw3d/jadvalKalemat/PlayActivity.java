...
import static com.haw3d.jadvalKalemat.jadvalKalematApplication.BOARD;
import static com.haw3d.jadvalKalemat.jadvalKalematApplication.RENDERER;
...
import com.haw3d.jadvalKalemat.PuzzleDatabaseHelper.SolveState;
import com.haw3d.jadvalKalemat.io.IO;
import com.haw3d.jadvalKalemat.puz.MovementStrategy;
import com.haw3d.jadvalKalemat.puz.Playboard;
import com.haw3d.jadvalKalemat.puz.Playboard.Clue;
import com.haw3d.jadvalKalemat.puz.Playboard.OnBoardChangedListener;
...
import com.haw3d.jadvalKalemat.view.CrosswordImageView;
import com.haw3d.jadvalKalemat.view.CrosswordImageView.ClickListener;
import com.haw3d.jadvalKalemat.view.CrosswordImageView.RenderScaleListener;
import com.haw3d.jadvalKalemat.view.PlayboardRenderer;
import com.haw3d.jadvalKalemat.view.SeparatedListAdapter;

public class PlayActivity extends jadvalKalematActivity {

    /** Extra data tag required by this activity */
    public static final String EXTRA_PUZZLE_ID = "puzzle_id";
    public static final String ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZآا";
    ...
    private static final int CLEAR_PUZZLE_DIALOG = 3;
    ...
    private boolean usePencil = false;
    ...
    private static final int MENU_ID_CLEAR_PUZZLE = 11;
    private static final int MENU_ID_USE_PENCIL=12;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        int usePencilStr = (usePencil ? R.string.menu_use_pencil : R.string.menu_use_pen);
        MenuItem usePencilItem = menu.add(Menu.NONE, MENU_ID_USE_PENCIL, Menu.NONE, usePencilStr)
                .setIcon(android.R.drawable.ic_menu_view);
        ...
        reveal.add(Menu.NONE, MENU_ID_CLEAR_PUZZLE,   Menu.NONE, R.string.menu_clear_puzzle);
        ...
        if (jadvalKalematApplication.isTabletish(metrics)) {
            utils.onActionBarWithText(showItem);
            utils.onActionBarWithText(usePencilItem);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        int usePencilStr = (showErrors ? R.string.menu_use_pencil : R.string.menu_use_pen);
        menu.findItem(MENU_ID_USE_PENCIL).setTitle(usePencilStr);
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        case MENU_ID_CLEAR_PUZZLE:
            deprecatedShowDialog(CLEAR_PUZZLE_DIALOG);
            return true;
        ...
        case MENU_ID_USE_PENCIL:
            usePencil = !usePencil;
            BOARD.setPencil(usePencil);
            int usePencilStr=(usePencil ? R.string.menu_use_pencil:R.string.menu_use_pen);
            item.setTitle(usePencilStr);
            render();
            return true;
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        ...
        case CLEAR_PUZZLE_DIALOG:
            return createClearPuzzleDialog();
    ...
    private Dialog createClearPuzzleDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(this);
        dialogBuilder
                .setTitle(getResources().getString(R.string.clear_puzzle_title))
                .setMessage(getResources().getString(R.string.reveal_puzzle_body))
                .setPositiveButton(
                        android.R.string.ok,
                        new DialogInterface.OnClickListener() {

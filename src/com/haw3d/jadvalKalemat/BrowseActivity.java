...
import com.haw3d.jadvalKalemat.PuzzleDatabaseHelper.IDAndFilename;
import com.haw3d.jadvalKalemat.net.Downloader;
import com.haw3d.jadvalKalemat.net.Downloaders;
import com.haw3d.jadvalKalemat.puz.PuzzleMeta;
import com.haw3d.jadvalKalemat.view.CustomFastScrollView;
import com.haw3d.jadvalKalemat.view.SeparatedListAdapter;
import com.haw3d.jadvalKalemat.view.VerticalProgressBar;
...
public class BrowseActivity extends jadvalKalematActivity implements OnItemClickListener {
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        try {
            ...
            Log.e("com.haw3d.jadvalKalemat", "bad menuInfo", e);
            return;
        }
...
//todo delete downloader, archive, cleanup
...
//            .setIcon(android.R.drawable.ic_menu_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getTitle().equals(MENU_DOWNLOAD)) {
            ...
            Intent i = jadvalKalematApplication.sendDebug(this);
            if (i != null) {
                this.startActivity(i);
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("جدول کلمات متقاطع");
        ...
        } else if (!jadvalKalematApplication.getDatabaseHelper().hasAnyPuzzles() &&
        ...
        case DOWNLOAD_DIALOG_ID:
            ...
            DownloadPickerDialogBuilder.OnDownloadSelectedListener downloadButtonListener = new DownloadPickerDialogBuilder.OnDownloadSelectedListener() {
                    public void onDownloadSelected(Calendar date, List<Downloader> downloaders, int selected) {
                        ...
                        //download(date, toDownload);   //todo: download in start
                    }
                };
    ...
    private boolean needDatabaseSync() {
        //todo sync time
        //long folderTimestamp = jadvalKalematApplication.CROSSWORDS_DIR.lastModified();
    ...
    public void syncDatabase() {
        ...
        File[] fileList = jadvalKalematApplication.CROSSWORDS_DIR.listFiles(
            new FilenameFilter() {
                public boolean accept(File dir, String name) {
                    return name.endsWith(".pzl");
                }
            });
        if (fileList == null) {
            LOG.warning("Unable to enumerate directory: " + jadvalKalematApplication.CROSSWORDS_DIR);
            return;
        }
    ...
    private void checkDownload() {
        ...
        if (prefs.getBoolean("dlOnStartup", true) &&
            ...
            //this.download(Calendar.getInstance(), null); //todo: download in start
            prefs.edit()

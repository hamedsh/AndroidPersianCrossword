    ...
    public static ScaleGestureDetectorProxy create(Context context, TouchImageView view)
    {
        if (android.os.Build.VERSION.SDK_INT >= 8)
        {
            try
            {
                ...
                Class<?> clazz = Class.forName("com.haw3d.jadvalKalemat.view.TouchImageView$ScaleListener");
                ...
                clazz = Class.forName("com.haw3d.jadvalKalemat.view.ScaleGestureDetectorProxy$ScaleGestureDetectorProxyFroyo");

...
public class PuzzleFinishedActivity extends jadvalKalematActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        long puzzleId = jadvalKalematApplication.BOARD.getPuzzleID();
        Puzzle puz = jadvalKalematApplication.BOARD.getPuzzle();
        ...
        final String shareMessage="test";
        //if (cheatedBoxes == 0) {
